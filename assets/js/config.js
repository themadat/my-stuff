(function () {
  ...
  window.LocalApp.config = Object.freeze({
    ...
    inventory: {
      defaultCurrency: "USD",
      currencies: ["USD"],
      locations: [{"zone": "Outside", "room": "Yard", "spaces": []}, {"zone": "Outside", "room": "Shed", "spaces": []}, {"zone": "Outside", "room": "Nest", "spaces": ["Box"]}, {"zone": "Outside", "room": "Patio", "spaces": ["Pickle Bag"]}, {"zone": "Outside", "room": "Garage", "spaces": ["Car"]}, {"zone": "Outside", "room": "Attic", "spaces": []}, {"zone": "Outside", "room": "Crawl", "spaces": []}, {"zone": "Main Level", "room": "Foyer", "spaces": []}, {"zone": "Main Level", "room": "Hallway", "spaces": []}, {"zone": "Main Level", "room": "Game Room", "spaces": []}, {"zone": "Main Level", "room": "Kitchen", "spaces": ["Pantry", "Fridge"]}, {"zone": "Main Level", "room": "Nook", "spaces": ["Floating", "Go Bag", "Sling", "Wash Pouch"]}, {"zone": "Main Level", "room": "Den", "spaces": ["Bar"]}, {"zone": "Main Level", "room": "Doge’s Den", "spaces": []}, {"zone": "Main Level", "room": "Mud Room", "spaces": []}, {"zone": "Main Level", "room": "Powder Room", "spaces": []}, {"zone": "Main Level", "room": "Primary Bedroom", "spaces": ["Closet"]}, {"zone": "Main Level", "room": "Primary Bathroom", "spaces": ["Closet", "Water Closet"]}, {"zone": "Upstairs", "room": "Loft", "spaces": ["Closet"]}, {"zone": "Upstairs", "room": "Office", "spaces": ["Closet", "Desk", "Cabinent"]}, {"zone": "Upstairs", "room": "Utility Room", "spaces": ["Closet"]}, {"zone": "Upstairs", "room": "Guest Room", "spaces": ["Closet"]}, {"zone": "Upstairs", "room": "J&J Bathroom", "spaces": ["Guest Sinkroom", "Loft Sinkroom"]}],
      tagGroups: [{"name": "Activity", "tags": ["Pickleball", "Backpacking", "Biking", "Golfing", "Paddles", "Soccer", "Climbing"]}, {"name": "Apparel", "tags": ["Headwear", "Eyewear", "Handwear", "Footwear", "Clothing", "Scarf"]}, {"name": "Systems", "tags": ["Fire", "Gas", "Climate", "Electrical", "Plumbing", "Security"]}, {"name": "Power", "tags": ["Coax/Ethernet", "Extension", "Powerstrip", "Plug"]}, {"name": "Lighting", "tags": ["Headlamp", "Flashlight", "Bulb", "Fixture", "Floor Lamp", "Table Lamp", "Strip", "Night", "String", "Puck"]}, {"name": "Smart", "tags": ["Doorbell", "Curtain", "Fan", "Hub", "Humidifier", "Lights", "Lock", "Sensor", "Shade", "Switch", "Air Purifier", "Outlet", "Thermostat", "Mediabox", "Detector", "Button"]}, {"name": "Tech", "tags": ["Speaker", "Router", "Remote", "TV", "Tracker", "Laptop", "Watch", "Phone", "Tablet", "Cables", "Powerbanks", "Chargers", "Headphones"]}, {"name": "Other", "tags": ["Battery", "Furniture", "Soccer Balls", "Bags", "Books", "Games", "Decoration", "Float", "Barware", "Glassware", "Dishware", "Appliances", "Tools", "Water Bottles", "Gym", "Health"]}, {"name": "Brands", "tags": ["Apple", "Fracture", "OXO", "Ryobi", "Popchart", "Nespresso"]}],
      brands: ["Logitech", "American Standard", "Spectra Metals", "Thermwell", "Walensee", "Adidas", "GE Profile", "Hamilton Beach", "Gatorade", "CamelBak", "HGN", "Leviton", "Nordic", "Govee", "Beats", "Vapur", "Final Touch", "Apple", "Fracture", "OXO", "Ryobi", "Popchart", "Nespresso"],
      brandCompanies: { Beats: "Apple", Govee: "Govee" },
      retailers: ["Amazon", "Target", "Walmart", "Costco", "IKEA", "eBay", "Best Buy"],
      roomAliases: { "dining room": "Game Room" },
      zoneOrder: ["Outside", "Main Level", "Upstairs"],
      locationAliases: { "Dining Room": { room: "Game Room" }, "Primary Closet": { room: "Primary Bedroom", space: "Closet" } },
      ...
      bulkSuggestions: [
        ...
        { match: "light bulb|led bulb|night light", tags: ["Bulb", "Strip"] },
      ...
      categories: [
        ...
        { name: "Glassware", properties: [{ name: "Capacity", unit: "oz" }] }
      ]
    },
    storage: {
    ...
    releases: [{
      version: "0.0.1.73", date: "2026-09-26T12:00:00.000Z", title: "Location Progress, Pieces and Purchase Totals",
      summary: "Overall location review progress, named set pieces, copy dates and clearer total pricing.",
      features: ["Named pieces with separate rooms", "Per-copy obtained dates", "Conveyed acquisition and Replaced departure", "Glassware Capacity in oz"], improvements: ["Total pricing defaults for new entries with per-copy breakdown", "Typed date separators and unknown Gone Date", "Last Updated calendar picker", "Compact location rows with one overall review percentage"], fixes: [], knownIssues: []
    }, {
      version: "0.0.1.72", date: "2026-09-26T12:00:00.000Z", title: "Household Locations and Review Progress",
      summary: "See every room and space, track review completion, and use updated household tags and symbols.",
      features: ["Empty rooms and spaces in Around the House", "Dated room highlighting and space review percentages", "Kitchen Fridge and Nest Box spaces"], improvements: ["Compact sidebar ordered Outside, Main Level, Upstairs", "Decoration and Fixture naming; Memorabilia removed", "Expanded Smart, Power, Lighting and Other tags with supplied symbols"], fixes: ["Migrate Dining Room assignments and review dates to Game Room"], knownIssues: []
    }, {
      version: "0.0.1.71", date: "2026-09-22T14:00:00.000Z", title: "More Household Categories",
      summary: "Corrected Headwear and Handwear and added six categories with supplied symbols.",
      features: ["Doorbell, Flashlight, Headlamp, Furniture, Speaker and Battery tags"], improvements: [], fixes: ["Headware and Handware migrate to Headwear and Handwear"], knownIssues: []
    }, {
      version: "0.0.1.70", date: "2026-09-22T12:00:00.000Z", title: "Household Smart Add and Item Search Shortcut",
      summary: "Smart Add understands household spreadsheet columns; press . to find an item.",
      features: ["Period shortcut for Find an Item"], improvements: ["Parse household locations, tags, dates, values and seller/object columns", "Preserve multiline warranty notes and recognize conveyed items"], fixes: [], knownIssues: []
    }, {
      ...
      version: "0.0.1.65", date: "2026-09-21T00:00:00.000Z", title: "Smart Devices and Expanded Activities",
      summary: "Smart becomes a top category beside Lighting, with reorganized device and activity tags.",
      features: ["Smart category", "Air Purifier, Powerstrip, Soccer, Climbing, Gym and Outlet subcategories"], improvements: ["Power follows Systems", "Smart device tags move from Tech", "Updated cable, power, activity and Brands symbols"], fixes: ["Existing Shades tags migrate to Shade"], knownIssues: []
    }, {
      version: "0.0.1.64", date: "2026-09-20T23:55:00.000Z", title: "Smarter Household Bulk Imports",
      summary: "Import household archive spreadsheets with long object names and complete departure notes.",
      features: ["Recognize room, optional tags/date, value, object and departure columns"], improvements: ["Suggest departure reasons while preserving the full explanation", "Recognize the supplied household brands", "Remove per-field text and column caps"], fixes: ["Ignore unused amount columns and imported durations", "Keep long imported text when saving and reopening"], knownIssues: []
    }, {
      ...
      version: "0.0.1.61", date: "2026-09-20T16:00:00.000Z", title: "Match Any or All Categories",
      summary: "Choose whether items must match any or all selected categories.",
      features: ["ANY / ALL toggle for multiple category filters"], improvements: ["ANY remains the default; Clear resets matching"], fixes: [], knownIssues: []
    }, {
      version: "0.0.1.60", date: "2026-09-20T15:00:00.000Z", title: "Tag Checklists and Synced Brand Favorites",
      summary: "Alphabetical tag checklists, visible preset properties and brand favorites shared across browsers.",
      features: ["Brand favorites included in GitHub Sync"], improvements: ["Vertical tag checklists with full-row selection", "Bracketed preset properties beside tags", "Smaller category icons keep labels visible"], fixes: [], knownIssues: []
    }, {
      version: "0.0.1.59", date: "2026-09-20T00:00:00.000Z", title: "Multiple Categories and Visible Presets",
      summary: "Select several quick categories and read preset properties directly.",
      features: ["Multiple category and tag filters with removable selections"], improvements: ["Selected categories stay white", "Tag picker stays open for repeated selections", "Preset properties are always visible beneath preset names"], fixes: [], knownIssues: []
    }, {
      version: "0.0.1.58", date: "2026-09-15T20:00:00.000Z", title: "Household Tags and Bulk Archive Entry",
      summary: "Refined household tags, compact rows, typed dates and bulk entry into Stuff I Had.",
      features: ["Delete custom tags in Settings Inventory", "Bulk Add in Stuff I Had"], improvements: ["Updated Systems, Tech and Lighting tags", "Location review dates stay beside totals", "Unselected categories turn gray"], fixes: ["Brand and category classification", "Type into unknown dates and save US or ISO dates"], knownIssues: []
    }, {
      version: "0.0.1.57", date: "2026-09-15T18:00:00.000Z", title: "Direct Archive Entry and Govee",
      summary: "Add items straight to Stuff I Had, with departure-aware Smart Complete.",
      features: ["Add directly to Had with gone date, reason and notes", "Govee company and symbol"], improvements: ["Rename Nook Sling Bag to Sling", "Add Nook Wash Pouch and Office Cabinent"], fixes: [], knownIssues: []
    }, {
      ...
      version: "0.0.1.54", date: "2026-09-14T23:30:00.000Z", title: "Force Reload Shortcut",
      summary: "Shift-Control-Option-R activates Update and force refresh.",
      features: ["Shift-Control-Option-R keyboard shortcut"], improvements: [], fixes: [], knownIssues: []
    }, {
      version: "0.0.1.53", date: "2026-09-14T23:00:00.000Z", title: "Location Totals and Smarter Defaults",
      summary: "Location headers and sidebar show totals, with ounce defaults and qualified closet recognition.",
      features: ["Count and value totals for every location"], improvements: ["Weight defaults to ounces", "Unknown dates display dashes", "Recognize Primary Closet and qualified room/space names"], fixes: [], knownIssues: []
    }, {
      version: "0.0.1.52", date: "2026-09-14T22:00:00.000Z", title: "Collapsible Locations and Aligned Copies",
      summary: "Collapse table locations, save with Command+Enter, and edit aligned copy fields.",
      features: ["Collapse zones, rooms and spaces directly in the object table", "Command+Enter saves Add or Edit Item"], improvements: ["Aligned #1 copy fields and Shared controls that clear overrides", "Tag guidance beside the header, fixed-position outlines and matching Notes height", "Stronger table headers and inline unit equivalents"], fixes: ["Keep the Update symbol visible in both update states"], knownIssues: []
    }, {
      version: "0.0.1.51", date: "2026-09-14T19:00:00.000Z", title: "Compact Editing and Smart Units",
      summary: "A tighter item form, metric equivalents and hovered object shortcuts.",
      features: ["Split recognized measurement units and show US equivalents", "Hover an object and press E to edit or A to open Archive"], improvements: ["Centered ownership symbols with tighter spacing", "Inline copy labels and shared controls", "Tags beside Notes and full-width custom properties"], fixes: [], knownIssues: []
    }, {
      version: "0.0.1.50", date: "2026-09-14T17:00:00.000Z", title: "Remember Sidebar Width",
      summary: "The sidebar proportion persists locally; ownership filtering and expansion have separate controls.",
      features: [], improvements: ["Separate ownership selection and totals chevrons"], fixes: ["Remember the sidebar percentage on this device without syncing it"], knownIssues: []
    }, {
      version: "0.0.1.49",
      date: "2026-09-14T16:07:03.910Z",
      title: "Mobile Filters and Expandable Totals",
      summary: "Mobile controls use separate rows, ownership details expand on demand, and room-only items appear before spaces.",
      features: [],
      improvements: ["Mobile rows separate search, location/category dropdowns, quick selections, and ownership/actions", "All, House, and Me start condensed on mobile and expanded on larger screens; click to toggle details and filter", "Expansion choices remain in effect during the session"],
      fixes: ["Items assigned to a room without a space appear first in that room"],
      knownIssues: []
    }, {
      ...
      version: "0.0.1.43", date: "2026-09-13T00:00:00.000Z", title: "Location Review Dates",
      summary: "Set a Last Updated Date beside each location count, or leave it UNKNOWN.",
      features: ["Manual location checks persist in backups and sync"], improvements: [], fixes: [], knownIssues: []
    }, {
      ...
      version: "0.0.1.40", date: "2026-09-13T00:00:00.000Z", title: "Per-Item Tag Order",
      summary: "Drag tags or use arrow buttons to reorder them for each item, with brand tags first and Float last.",
      features: ["Favorited brands add matching brand tags"], improvements: ["Tag order persists with inventory records"], fixes: [], knownIssues: []
    }, {
    ...
    roadmap: [],
    helpTopics: [
      {"id": "bulk-entry", "title": "Bulk Spreadsheet Entry", "section": "Inventory", "keywords": "bulk spreadsheet import excel xlsx csv tsv paste queue review skip pause resume tags groups", "html": "<p>Choose Bulk Entry in Stuff I Have or Stuff I Had. Had batches retain their destination when paused and require departure details before saving. Select an XLSX, CSV, or TSV file, or paste cells copied from a spreadsheet. Select a worksheet and check First Row Contains Headings. Expand Column Mapping to correct field assignments; unknown columns become Notes by default or can be mapped to a custom property. Every row goes through Smart Complete. Household Have rows follow location, optional comma-separated tags, optional Date Obtained, dollar value and Seller - Object, with blank separators allowed. A zone such as Outside stays a zone without guessing a room. Multiline warranty text stays in Notes; [CONVEYED] uses Conveyed with obtaining price $0 and obtained date 12/17/2020, preserving its marker in Notes. Legacy LED and HVAC import tags become Strip and Climate. Press . outside an editor to focus Find an Item. In Stuff I Had, household export rows follow room, optional categories and acquired date, value, then object (which can include seller and brand); blank separators are allowed. The next three columns are ignored, followed by Gone Date, an ignored duration, and the full departure explanation. A reason is suggested and the explanation stays in Departure Notes. Imported durations are recalculated from dates. Text fields and spreadsheet columns have no individual length/count cap; overall file, queue and batch limits still apply. Leading configured rooms or unique spaces are recognized; tab-separated tags, US/ISO dates and dollar prices are extracted. Floating resolves to Nook in Main Level. Known trailing tags after a bracketed value are retained. Unknown trailing text stays in Notes. Float is a known tag and is added automatically for the Floating space. Ambiguous spaces such as Closet need a room choice.</p><p>Start Review opens each object with its source populated in the expanded Smart Complete area, highlights, and destination buttons. Entered values use white text on contrasting fields even after manual edits; only placeholders are gray. Manual corrections survive pause and resume. Suggestions to check lists inferred tags with their groups, rooms, spaces and properties. Imported values take precedence. Me and Purchased remain the defaults unless the row specifies otherwise. Colors and explicit measurements can fill properties; category presets add relevant blank fields. Water Bottles includes Volume, and recognized bottle measurements fill oz, mL or L. Product text such as Pack of 2 does not create copies without a quantity column. Expand Original Row to compare with the source. Edit any field, then Save &amp; Next to add that object. Skip leaves it unsaved for later; Review Skipped returns to those rows. Finishing the review returns home; open Bulk Entry again to revisit skipped rows. Pause keeps your current form edits for Resume Review after a reload.</p><p>Each quantity becomes a separately reviewed copy. You can also increase Copies while reviewing a row, with room and space choices per copy; Save &amp; Next saves the first and queues the extra copies for individual review. Prices and values are per object. Use up to 500 objects per batch and files under 8 MB (CSV/pasted text under 4 MB). XLSX imports read cached formula values without evaluating formulas; export older XLS files first. Suggestions use offline matching rules and do not invent missing prices or dates.</p><p>Pending queues stay in this browser on this device and are excluded from backups and cloud sync. Keep the source spreadsheet until review is complete. Saved objects participate in normal inventory backup and sync. Starting another batch asks before replacing pending or skipped rows.</p>"},
      ...
      { id: "inventory-options", title: "Inventory Options and Copies", section: "Inventory", keywords: "copies duplicate quantity multiple color colours zones spaces groups property presets settings", html: "<p>For matching objects, set Total Copies before saving. Each copy becomes a separate item with its own room, color, properties, value, and archive status. For two or more copies, horizontal Zone, Room and Space rows use autocomplete. A known room supplies its zone and a unique space supplies its room and zone; ambiguous spaces require choosing a parent. Assign optional locations per copy; blank fields use the location above. Sling Bag is a space under Nook, Main Level. A different room clears the inherited space and uses the known parent zone. New entries default to overall totals; use the amount selector to enter per-copy prices instead. You can add up to 100 copies at once, within the 5,000-item inventory limit.</p><p>Open a saved current item to see Total Copies and edit each copy’s room and space. Increase the total to create more copies; decrease it to remove the last rows, with a permanent-deletion confirmation. Copy 1 is the item you opened. Other existing copies keep their own properties and values. Archived copies are excluded from this total. Older identical records are recognized across locations; new copy groups stay linked after edits. Update all devices to preserve these links during sync.</p><p>Color is available for every object under More Details. Choose Color to add or focus its property row; saved color values become suggestions. The wider Settings → Inventory has three columns for locations, tags and properties, stacked on narrow screens. Rooms show their spaces alongside them. Select a zone, room, space, tag, group, property or property value to close Settings and open Stuff I Have with that filter. Tag groups match any member; property groups match objects with any property in the group. It includes configured and used values. Star a brand in the Brands list or Brand property values to move it to the top of brand lists and suggestions. Favorites are included in backups and GitHub Sync, including removing favorites. Sync each browser to share your favorites. Update older browsers before syncing the new cloud format. Merge Both Copies combines favorites from both copies. Search to find any option. Use Delete beside a Custom Tag to remove it from all current and archived items. This catalog shows available and used options; enter custom values in the item form.</p>" },
      { id: "inventory-details", title: "Item Details and Categories", section: "Inventory", keywords: "properties tags shoes size weight color backpacking cables length obtained price source gift", html: "<p>Select Edit to open an item. Select its name, tag, property, notes, seller, location, owner, value or date to instantly filter the list. Clear Filters removes the selection. Matching current objects with the same name, brand, owner and room share a row. Count shows the number of copies; Value is their combined known value. Different properties remain visible. Edit opens the copies editor; Archive applies to one copy. Archived histories remain separate. Main-page values round to whole dollars without changing saved amounts; the form keeps cents. Compact All/House/Me cards show Everything and Filtered counts and values. Me uses fire red and House uses amber. Record when and how you obtained it, where it came from, what you paid, and its current estimated value. If one amount is unknown, it uses the other amount. Both blank means unknown; explicit zero and different amounts are preserved. This also applies when existing records or backups are normalized.</p><p>Search and select tags individually, or type custom tags and press Enter. Drag selected tags or use their arrow buttons to reorder them for this item; brand tags stay first and Float stays last. Favoriting a brand adds its tag to matching Brand records when there is room within the 30-tag limit. Unfavoriting keeps existing tags. Zones, rooms, and spaces include the household vocabulary; choosing a space fills its parent room and zone. Brand, Zone, and Space use existing custom-property storage for backup and sync compatibility. Presets suggest size, color, and weight for shoes, weight for backpacking gear, Length, End A and End B for Cables, and Volume for Water Bottles. Applied sets have highlighted borders and an × button. Select × to remove that set and its tag; properties still used by another selected set remain. Add custom properties with a name, value, and optional unit. Color, Size, End A, End B and Output Ports omit the unit field. Removing a category never removes an existing property.</p>" },
      { id: "inventory-stats", title: "Rooms, Ownership, and Totals", section: "Inventory", keywords: "stats totals house personal room value count currency", html: "<p>Ownership is separate from location: your belongings and house belongings can share a room. Counts and known-value totals include all current items, even when the list is filtered. Room totals separate House and Me; items with no known location appear under Unknown Location. When value is missing, obtaining price supplies it. Items with both amounts unknown are excluded from value totals. The top bar contains Have, Want, Research and Had beside Search Everything. Underlined letters indicate their keyboard shortcuts. Search covers current and archived inventory details, catalog options, Notes, settings, help and releases. Select All, House or Me to filter ownership. Use its separate chevron to expand or collapse totals. The sidebar divider percentage is saved on this device only. Ownership buttons start condensed on mobile and expanded on larger screens; your toggles last for the session. On mobile, search, quick selections, and ownership/action buttons occupy three rows. Items assigned to a room without a space appear before that room’s spaces. Around the House lists all configured rooms and spaces, including empty locations, in Outside, Main Level, Upstairs order. Dated locations are highlighted. The single percentage above the date column counts reviewed areas, rooms and spaces out of the full location list. Each location counts once; filtering does not change this progress. Click an empty location to filter it. Around the House shows value to the right of count. Table location headers show the same filtered descendant count and value in the object columns. Table location headings expand or collapse their contents independently of the sidebar; sidebar links reveal their destination. Subcategory checkboxes show a symbol and object count in parentheses for the current Have or Had view. Counts include all objects in that view, like category card totals. Selected filter chips keep the symbol beside the name. Category quick selections toggle multiple groups and tags, showing items that match any selection by default. With multiple selections, choose ANY to match at least one or ALL to require every selected category or tag. A selected group still matches any tag within that group. Clear resets the mode to ANY. Selected cards stay white. Hover or focus a group to see tags; press Down Arrow to enter the picker. Tags are alphabetical checkbox rows; click anywhere in a row to select or clear it. Preset properties appear in brackets on the right. Select multiple tags without closing it, then press Escape or click outside. Remove individual selections with their × buttons, or use Clear. Preset properties appear directly beneath tag and property-set names. Right-click a location in Around the House, or focus it and press Shift+F10, to filter its zone, room or space. Repeat to remove that filter, or use the visible Location filter label or Clear. Left-click still jumps to the location.</p><p>New single entries default to Total for all copies / pieces. Increase Total Copies and enter the overall obtaining price and current value, or choose Per copy / piece. The breakdown shows both totals and per-item amounts; any extra cents go to the first copies. Existing item edits and imported bulk rows initially use per-item amounts. Choose Named pieces of one set to label parts and place them in separate rooms; pieces stay linked through their set. Uncheck Shared Date to give a copy its own obtained date; blank means unknown. Glassware automatically adds Capacity in oz. Conveyed sets obtaining price to $0 and Date Obtained to 12/17/2020. Typed dates beginning with 20 receive ISO dashes; other numeric dates receive month/day/year slashes. Last Updated uses a calendar picker. Around the House shows one overall percentage of locations with Last Updated dates, counting areas, rooms and spaces individually. Open Stuff I Had and choose Add to create an archived item directly. A departure reason is required; Gone Date can be Unknown. For tab-separated Smart Complete in this mode, the last date is the departure date (an earlier date is Date Obtained), the first two dollar amounts are price and value, and a final reason such as Broken; replaced supplies the reason and departure note. Review the fields before saving. In Add or Edit Item, Command+Enter saves (Control+Enter also works). Checking Shared clears that copy’s override. Drag movable tags or use Alt+Arrow Keys to reorder; fixed-position tags have gray outlines. Hover an object row and press E to edit or A to open its archive form. These shortcuts pause while typing or a dialog is open. Enter measurements such as 250g or 1.5 kg in property values: recognized units split automatically. New Weight properties default to ounces. Metric values stay metric with an approximate US equivalent alongside. Unknown dates show dashes. Smart Complete recognizes Primary Closet as Main Level / Primary Bedroom / Closet, and supports full room-plus-space names. Size and other unitless properties stay unchanged.</p><p>All values and prices are in USD. Currency is fixed for this app.</p>" },
      { id: "inventory-archive", title: "Stuff I Had", section: "Inventory", keywords: "archive gone lost broken trashed sold donated duration previous return", html: "<p>Use the far-right Archive button or open an item and select Archive to record its gone date, reason, and optional departure notes. The archive form shows calendar age and obtaining price divided by elapsed years (current value is the fallback). Same-day or unknown dates/amounts cannot provide an annual average. It moves to Stuff I Had and stops counting toward current totals. Days owned are calculated from the obtained date to the gone date; unknown obtained or departure dates have unknown duration.</p><p>Archived details remain editable. Return to Stuff I Have clears its departure details and restores it to current totals. Delete Item permanently removes an accidental entry after confirmation, without archiving it. Other copies remain. This action cannot be undone.</p>" },
