(function () {
  ...
  window.LocalApp.config = Object.freeze({
    ...
    inventory: {
      ...
      tagGroups: [{"name": "Activity", "tags": ["Pickleball", "Backpacking", "Biking", "Golfing", "Hiking"]}, {"name": "Apparel", "tags": ["Headware", "Eyewear", "Handware", "Footwear", "Clothing", "Scarf"]}, {"name": "Power", "tags": ["Coax", "Ethernet", "Extension"]}, {"name": "Systems", "tags": ["Fire", "Climate", "Smart", "Electrical", "Plumbing", "Security"]}, {"name": "Lighting", "tags": ["Bulb", "Decor", "Strip", "Night", "String"]}, {"name": "Tech", "tags": ["Lights", "Fan", "Switch", "Curtain", "Hub", "Lock", "Remote", "Sensor", "Shades", "TV", "Tracker", "Laptop", "Watch", "Phone", "Tablet", "Cables", "Powerbanks", "Chargers", "Headphones"]}, {"name": "Other", "tags": ["Paddles", "Soccer Balls", "Bags", "Books", "Games", "Art", "Memorabilia", "Float", "Barware", "Glassware", "Dishware", "Appliances", "Tools", "Water Bottles"]}, {"name": "Brands", "tags": ["Apple", "Fracture", "OXO", "Ryobi", "Popchart", "Nespresso"]}],
